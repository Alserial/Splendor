...
class myAgent(Agent):
    def __init__(self, _id):
        ...
        try:
            ...
            self.weights = {
                ...
                "can_buy_count": 0,
                "noble_potential": 0,
                "yellow_gem_utility": 0,
                "dealt0_gem_demand": 0.6,
                "dealt1_gem_demand": 0.6,
                "dealt2_gem_demand": 0.6,
                "card_points": 1.5,
                "card_cost": -0.2,
                "noble_demand": 1,
                "get_noble": 10,
    ...
    def get_next_actions(self,game_state:SplendorState):
        ...
        # display_cards = game_state.board.dealt_list() + cards["yellow"]
        ...
        #         if card.points < 3 and (card.colour not in noble_colour):
        #             continue
        #     else:
        #         if card.points < 2:
        #             continue
        #     for color, num in card.cost.items():
        #         if card_len[color] < num:
        #             shortage_gems[color] += 1
        ...
        for a in next_actions:
            ...
            # elif "collect" in a["type"]:
            #     for colour in a["collected_gems"]:
            #         if shortage_gems[color] <= 2:
            #             break
            #     useful_actions.append(a)
    ...
    # Used to calculate how many gems are missing to buy a card
    ...
    def ExtractFeatures(self, state: SplendorState, action):
        ...
        if "collect" in action["type"]:
            for i in range(3):
                # Calculating Gemstone Requirements
        ...
        if "reserve" in action["type"]:
            ...
            for oppo_action in oppo_actions:
                if "buy" in oppo_action["type"]:
                    ...
                    # Prevent your opponent from obtaining a Noble Card
